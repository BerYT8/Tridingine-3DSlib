...
* `--exclude <pattern>` — Excludes files matching the specified pattern. The option can be specified multiple times.been installed through CMake.
...
This updates the project with only modified essential files.
