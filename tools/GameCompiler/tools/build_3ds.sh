...
cd "$CODE_DIR" || exit 1
/opt/devkitpro/msys2/usr/bin/cmake ../.. -DBUILD_3DS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE="${DEVKITPRO}/cmake/3DS.cmake"
/opt/devkitpro/msys2/usr/bin/cmake --build . || exit 1
...
/opt/devkitpro/msys2/usr/bin/cmake ../../../3ds \
  -DCODE="../../code.elf" \
